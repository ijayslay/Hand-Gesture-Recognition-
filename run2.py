...
def on_enter(e):
    button1['background'] = '#222'
    button1['foreground'] = '#fff'

def on_leave(e):
    button1['background'] = '#fff'
    button1['foreground'] = '#222'
...
def on_enter(e):
    button2['background'] = '#222'
    button2['foreground'] = '#fff'

def on_leave(e):
    button2['background'] = '#fff'
    button2['foreground'] = '#222'
